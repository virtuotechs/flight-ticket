...
const TicketBooking = ({flights}) => {
            ...
            const [popularitySort,setPopularitySort]=useState(false);
                                                    ...
                                                    <span className='hidden-xs'>Sort by : </span>
                                                        <div className="select_box outline"  style={{ float: 'right' }}>
                                                            <Form.Control as="select" name="preferedFlightClass">
                                                                ...
                                                                <option value="4">Outbound: Departure Time</option>
                                                                <option value="5">Airline</option>
                                                                <option value="6">Stops</option>
                                                            </Form.Control>
                                                        </div>
                                                </Col>
                                            </Row>
